...
> **Generated**: 2026-08-17 19:58:17 UTC | **Repository**: `Vedic-Quant-37-Mo-Su-La-Nak-Retro-Panchang-Findings`
...
| Hypothesis / Astronomical Test | Direction | Support $N$ | Anomaly % | Baseline % | Lift Ratio | Fisher $p$-value | BH-FDR $q$-value |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| N/A | **ALL** | 238 | 16.9% | 14.8% | **1.14x** | `1.00e+00` | `1.00e+00` |
| N/A | **ALL** | 316 | 22.4% | 17.4% | **1.29x** | `1.00e+00` | `1.00e+00` |
| N/A | **ALL** | 151 | 10.7% | 12.1% | **0.89x** | `1.00e+00` | `1.00e+00` |
| N/A | **ALL** | 126 | 8.9% | 11.5% | **0.78x** | `1.00e+00` | `1.00e+00` |
| N/A | **ALL** | 0 | 0.0% | 0.0% | **0.00x** | `1.00e+00` | `1.00e+00` |
| N/A | **ALL** | 0 | 0.0% | 0.0% | **0.00x** | `1.00e+00` | `1.00e+00` |
...
| Hypothesis / Astronomical Test | Direction | Support $N$ | Anomaly % | Baseline % | Lift Ratio | Fisher $p$-value | BH-FDR $q$-value |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| Bhv_Sun_Lagna | **ALL** | 130 | 9.2% | 0.0% | **infx** | `7.25e-181` | `6.28e-178` |
| Bhv_Mercury_Lagna | **ALL** | 102 | 7.2% | 0.0% | **infx** | `1.28e-141` | `5.54e-139` |
| Bhv_Mercury_Lagna | **ALL** | 81 | 5.8% | 0.0% | **infx** | `2.38e-112` | `6.88e-110` |
| Bhv_Venus_Lagna | **ALL** | 63 | 4.5% | 0.0% | **466.79x** | `9.17e-83` | `1.98e-80` |
| Bhv_Sun_Lagna | **ALL** | 57 | 4.0% | 0.0% | **infx** | `4.57e-79` | `7.91e-77` |
| Bhv_Venus_Lagna | **ALL** | 55 | 3.9% | 0.0% | **infx** | `2.66e-76` | `3.84e-74` |

### Pillar 3: Harmonic Divisional Vargas (D9 Navamsha, D10 Dashamsha, D60 Shashtiamsha, Vargottama)

| Hypothesis / Astronomical Test | Direction | Support $N$ | Anomaly % | Baseline % | Lift Ratio | Fisher $p$-value | BH-FDR $q$-value |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| Mercury_Vargottama | **ALL** | 1338 | 95.0% | 90.8% | **1.05x** | `5.79e-09` | `8.11e-07` |
| Mercury_Vargottama | **ALL** | 70 | 5.0% | 9.2% | **0.54x** | `5.79e-09` | `8.11e-07` |
| Saturn_D60 | **ALL** | 98 | 7.0% | 11.0% | **0.63x** | `5.45e-07` | `5.09e-05` |
| Sun_D9 | **ALL** | 75 | 5.3% | 8.4% | **0.63x** | `1.63e-05` | `1.14e-03` |
| Venus_D60 | **ALL** | 172 | 12.2% | 8.9% | **1.37x** | `4.24e-05` | `2.37e-03` |
| Mars_D9 | **ALL** | 81 | 5.8% | 8.7% | **0.66x** | `7.51e-05` | `3.51e-03` |

### Pillar 4: Jaimini Chara Karakas (GK Crash Karaka vs AK Trend Karaka)

| Hypothesis / Astronomical Test | Direction | Support $N$ | Anomaly % | Baseline % | Lift Ratio | Fisher $p$-value | BH-FDR $q$-value |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| Jaimini_BK | **ALL** | 154 | 10.9% | 14.7% | **0.74x** | `4.93e-05` | `2.41e-03` |
| Jaimini_BK | **ALL** | 248 | 17.6% | 13.9% | **1.27x** | `1.43e-04` | `3.49e-03` |
| Jaimini_AmK | **ALL** | 248 | 17.6% | 14.1% | **1.25x** | `3.28e-04` | `5.36e-03` |
| Jaimini_AK | **ALL** | 159 | 11.3% | 14.3% | **0.79x** | `1.34e-03` | `1.65e-02` |
| Jaimini_DK | **ALL** | 193 | 13.7% | 11.2% | **1.23x** | `3.86e-03` | `3.78e-02` |
| Jaimini_GK | **ALL** | 278 | 19.7% | 16.9% | **1.17x** | `7.34e-03` | `5.26e-02` |

### Pillar 5: Ashtakavarga Matrices (SAV Point Thresholds < 25 vs > 32 Bindus)

| Hypothesis / Astronomical Test | Direction | Support $N$ | Anomaly % | Baseline % | Lift Ratio | Fisher $p$-value | BH-FDR $q$-value |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| SAV_Scorpio | **ALL** | 0 | 0.0% | 0.0% | **1.00x** | `1.00e+00` | `1.00e+00` |
| SAV_Aquarius | **ALL** | 0 | 0.0% | 0.0% | **1.00x** | `1.00e+00` | `1.00e+00` |
| SAV_At_Venus | **ALL** | 0 | 0.0% | 0.0% | **1.00x** | `1.00e+00` | `1.00e+00` |
| SAV_At_Mercury | **ALL** | 0 | 0.0% | 0.0% | **1.00x** | `1.00e+00` | `1.00e+00` |
| SAV_Libra | **ALL** | 0 | 0.0% | 0.0% | **1.00x** | `1.00e+00` | `1.00e+00` |
| SAV_Pisces | **ALL** | 0 | 0.0% | 0.0% | **1.00x** | `1.00e+00` | `1.00e+00` |

### Pillar 6: 6-Fold Shadbala Potency & Astangata Planetary Combustion

*Pillar hypotheses evaluated with non-spurious baseline calibration.*
...
| Hypothesis / Astronomical Test | Direction | Support $N$ | Anomaly % | Baseline % | Lift Ratio | Fisher $p$-value | BH-FDR $q$-value |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| Vim_MD | **ALL** | 43 | 3.1% | 0.0% | **infx** | `9.82e-60` | `2.06e-58` |
| Vim_AD | **ALL** | 22 | 1.6% | 0.0% | **infx** | `7.57e-31` | `7.95e-30` |
| Vim_AD | **ALL** | 278 | 19.7% | 14.6% | **1.36x** | `2.50e-07` | `1.75e-06` |
| Vim_MD | **ALL** | 607 | 43.1% | 49.7% | **0.87x** | `1.38e-06` | `7.24e-06` |
| Vim_AD | **ALL** | 142 | 10.1% | 14.2% | **0.71x** | `6.31e-06` | `2.65e-05` |
| Vim_AD | **ALL** | 282 | 20.0% | 15.7% | **1.28x** | `2.07e-05` | `7.26e-05` |
