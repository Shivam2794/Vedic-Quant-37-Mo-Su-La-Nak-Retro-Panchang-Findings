...
def train_meta_labeler(ticker):
    print(f"[{ticker}] Training V22 XGBoost Meta-Labeler on Latent States (Fixed Chronological Split)...")
    ...
    # The latent encoder and grinder both used 54.5% of the BARS as the In-Sample period.
    ...
    all_preds = (all_probs > 0.40).astype(int)
    ...
    model_file = f"{ticker}_V22_metalabeler.pkl"
