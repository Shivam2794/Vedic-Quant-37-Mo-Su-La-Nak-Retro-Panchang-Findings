...
def compile_v20_portfolio():
    print("Compiling v20 Concurrency-Aware Portfolio (with XGBoost Meta-Label Filtering)...")
    ...
    print(f"v20 Portfolio Win Rate: {win_rate:.2%}")
    print(f"v20 Portfolio Sharpe:   {sharpe:.2f}")
    
    df_port.to_parquet('portfolio_v20_executed_trades.parquet')
    print("Executed trades saved to portfolio_v20_executed_trades.parquet")

if __name__ == '__main__':
    compile_v20_portfolio()
